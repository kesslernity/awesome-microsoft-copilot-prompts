...
> 📄 **Free first:** **[Copilot on One Page](https://www.kesslernity.com/copilot-on-one-page?utm_source=github&utm_medium=readme&utm_campaign=prompts_repo&utm_content=outlook_automation)** is a one-page cheat sheet for phrasing prompts so they come back with something usable. Print it, then work through the list below.
