...
> Master Microsoft 365 Copilot for finance, HR, and analytics roles. Contains [APPROVED] production-safe prompts for Finance/FinOps, HR/Communications, and Data Office/Analytics professionals with role-specific guardrails.
...
#### 1. [APPROVED] Audit Support Research
...
#### 1. [APPROVED] Dashboard Feedback Summary
...
#### 1. [APPROVED] Budget Variance Explanation Draft
...
#### 1. [APPROVED] Governance Communication Draft
...
#### 2. [APPROVED] Data Definition Research
...
#### 1. [APPROVED] Data Quality Issue Research
...
#### 1. [EXPERIMENTAL] Engagement Theme Analysis
...
⚠️ EXPERIMENTAL: Email feedback may not be representative. Use proper employee survey tools for formal engagement measurement.
```
...
#### 1. [APPROVED] FinOps Cloud Cost Discussion Search
...
#### 1. [APPROVED] Financial Review Preparation
...
#### 1. ⚠️ Finance & HR Copilot Guardrails
