...
> Master Microsoft 365 Copilot for engineering and construction roles. Contains [APPROVED] production-safe prompts for EPC Engineers, Engineering Managers, and Construction/Site Engineers with role-specific guardrails.
...
#### 1. [APPROVED] Document Search for Field Use
...
#### 1. ⚠️ Engineering Copilot Guardrails
...
#### 1. [EXPERIMENTAL] Lessons Learned Collection
...
⚠️ EXPERIMENTAL: Copilot may miss context or misinterpret tone. Always validate findings with the project team.
```
...
#### 1. [APPROVED] Engineering Meeting Preparation
...
#### 2. [APPROVED] Design Review Meeting Preparation
...
#### 1. [APPROVED] Predecessor Issue Search
...
#### 1. [APPROVED] Project Correspondence Search
...
#### 1. [EXPERIMENTAL] Punch List Consolidation
...
⚠️ EXPERIMENTAL: May miss items or duplicate entries. Always reconcile with the official punch list system.
```
...
#### 1. [APPROVED] Site Coordination Summary
...
#### 1. ⚠️ Construction Safety Guardrails
...
#### 1. [APPROVED] Stakeholder Communication Draft
...
#### 1. [APPROVED] Action Item Tracking
...
#### 1. [APPROVED] Team Status Consolidation
...
#### 1. [APPROVED] Technical Document Summary
...
#### 2. [EXPERIMENTAL] Specification Outline Draft
...
⚠️ EXPERIMENTAL: Copilot may not find relevant templates or may miss critical sections. Always verify against industry standards and company procedures.
```
