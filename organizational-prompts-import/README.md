...
Before you import anything, **[Copilot on One Page](https://www.kesslernity.com/copilot-on-one-page?utm_source=github&utm_medium=readme&utm_campaign=prompts_repo&utm_content=org_csv)** is the free one-page cheat sheet worth publishing alongside the library, so users know how to phrase a prompt once they find one.
